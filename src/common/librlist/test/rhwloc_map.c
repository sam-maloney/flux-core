...
void test_count (void)
{
    ...
    ok (rhwloc_map_count_type (NULL, NULL) < 0 && errno == EINVAL,
        "rhwloc_map_count_type m=NULL type=NULL returns EINVAL");
    ok (rhwloc_map_count_type (NULL, "core") < 0 && errno == EINVAL,
        "rhwloc_map_count_type m=NULL type=core returns EINVAL");
    ok (rhwloc_map_count_type (m, NULL) < 0 && errno == EINVAL,
        "rhwloc_map_count_type type=NULL returns EINVAL");
    ok (rhwloc_map_count_type (m, "foo") < 0 && errno == EINVAL,
        "rhwloc_map_count_type type=foo returns EINVAL");
