...
class ResourceMapper:
    ...
    def map(self, R, extra_properties=None):
        ...
        Args:
            ...
            extra_properties: Optional dict of additional systemd unit
                properties (e.g. from ``exec.sdexec-properties``) that the
                mapper may use or scale.  Passed through to
                :meth:`finalize_properties`.  ``None`` preserves existing
                behavior.
        ...
        return self.finalize_properties(result, R, extra_properties=extra_properties)
    ...
    def finalize_properties(self, properties, R, extra_properties=None):
        ...
        Args:
            ...
            extra_properties: Optional dict of additional systemd unit
                properties passed through from :meth:`map`.  Subclasses may
                inspect or scale these.  The base implementation ignores it.
